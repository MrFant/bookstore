                    ...
                    <tr>
                        <td>
                            ...
                            <div style="margin-top:20px; margin-bottom:5px">
                                <img src="${pageContext.request.contextPath }/WebContent/client/images/productlist.gif"
                                     width="100%" height="38"/>
                            </div>
                                    ...
                                    <c:forEach items="${bean.ps}" var="p" varStatus="vs">
                                        ...
                                        <td>
                                            ...
                                            <div class="divlisttitle">
                                                <a href="${pageContext.request.contextPath}/findProductById?id=${p.id}">书名： ${p.name}<br/>售价：￥${p.price}
                                                </a>
                                            </div>
                                        </td>
                                    </c:forEach>
                            ...
                            <div class="pagination">
                                <ul>
                                    ...
                                    <c:if test="${bean.currentPage==1}">
                                        <%--only 1 page, the button is disable--%>
