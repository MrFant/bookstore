									...
									<tr>
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														<td style="text-align:center; padding-top:20px">
															<img src="${pageContext.request.contextPath }/WebContent/client/images/logintitle.gif" width="150" height="30" />
														</td>
													</tr>
													<tr>
														<td style="text-align:center;padding-top:20px;"><font
															color="#ff0000">${requestScope["login_message"]}</font>
															<%--login_message 反馈登陆账户是否已激活--%>
														</td>
													</tr>
													<tr>
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td colspan="2"
																		...
																		src="${pageContext.request.contextPath }/WebContent/client/images/loginbutton.gif" width="90" height="30" />
																	</td>
																</tr>

																<tr>
																	<td colspan="2" style="padding-top:10px">
																		<img src="${pageContext.request.contextPath }/WebContent/client/images/loginline.gif" width="241" height="10" />
																	</td>
																</tr>
																<!-- <tr>
																	<td colspan="2"
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
											...
											<p style="text-align:left">
												<a href="${pageContext.request.contextPath }/WebContent/client/register.jsp">
													<img src="${pageContext.request.contextPath }/WebContent/client/images/signupbutton.gif" width="135" height="33" />
												</a>
											</p>
										</td>
									</tr>
